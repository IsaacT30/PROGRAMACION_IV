...
export default function VideoPlayerScreen() {
  ...
  <Text style={{ color: colors.primary, fontSize: 20 }}>Video (Historia clínica)</Text>

  <Text style={{ color: colors.text }}>Pega la URL del video asociado a la historia clínica (mp4, HLS, etc.):</Text>
      <TextInput
        value={url}
        onChangeText={setUrl}
        autoCapitalize="none"
