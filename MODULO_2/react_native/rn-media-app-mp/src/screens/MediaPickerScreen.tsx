...
export default function HistoriasClinicasScreen({ navigation }: any) {
  ...
  <Text style={{ color: colors.primary, fontSize: 20 }}>Imágenes ( Cuadro clínico)</Text>
  ...
  <Text style={{ color: colors.primary, fontSize: 20 }}>Video adjunto (Video clínico)</Text>
  ...
  <Text style={{ color: colors.primary }}>Seleccionar video</Text>
      ...
      {videoUri ? (
        ...
        <Text style={{ color: colors.subtle }}>No hay video adjunto.</Text>
      )}
